...
public class ObstacleController3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if ((GameObject.Find("FPSController").transform.position.x >= -5.1) && (GameObject.Find("FPSController").transform.position.x <= -2.5))
            {
                if ((GameObject.Find("FPSController").transform.position.z <= -9.1) && (GameObject.Find("FPSController").transform.position.z >= -10.1))
                {
